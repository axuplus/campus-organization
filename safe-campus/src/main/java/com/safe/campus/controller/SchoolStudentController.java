...
public class SchoolStudentController extends BaseController {
    ...
    @ApiOperation("获取学生")
    @GetMapping("/get")
    public Wrapper<SchoolStudentVo> getStudent(@RequestParam("id") Long id) {
    ...
    public PageWrapper<List<SchoolStudentListVo>> listStudent(@ApiParam("1全部2年级3班级") @RequestParam("type") Integer type,
                                                              ...
                                                              @ApiParam("type=2的话就是年级 3的话就是班级id") @RequestParam(value = "id", required = false) Long id,
    ...
    public Wrapper<List<SchoolStudentBuildingVo>> getStudentBuildingInfo(@RequestParam("masterId") Long masterId,
