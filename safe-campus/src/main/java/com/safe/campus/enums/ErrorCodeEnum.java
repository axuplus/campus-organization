...
public enum ErrorCodeEnum {
    ...
    PUB10000023(10000023, "此床位已经有学生了,请检查床位信息后重新导入"),
    ...
    PUB10000032(10000032, "参数不能为空"),
    PUB10000033(10000033, "楼幢信息有误,请核对后导入"),
    PUB10000034(10000034, "身份证号码有重复"),
    PUB10000035(10000035, "图片没有对应学生,请确认后导入"),
