        ...
        <div style="margin:5px 10px;">
            ...
            <list:listview id="listview">
                ...
                <list:colTable isDefault="false" rowHref="/fssc/base/fssc_base_account/fsscBaseAccount.do?method=view&fdId=!{fdId}" name="columntable">
                    <list:col-checkbox />
                    <list:col-serial/>
                    <list:col-auto props="fdName;fdPerson.fdId;fdBankName;fdBankAccount;fdPerson.name;fdIsDefault.name;fdIsAvailable.name;docCreator.name;docCreateTime;operations" /></list:colTable>
            </list:listview>
            <!-- 翻页 -->
            <list:paging />
        </div>
